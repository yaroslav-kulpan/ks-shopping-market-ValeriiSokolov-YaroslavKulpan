...
for (let i = 0; i < quickView.length; i++) {
  quickView[i].addEventListener('click', function (e) { // console.log($(this).data('id'));
    e.preventDefault();
    let img = '';
          ...
          <div class="col-7 d-flex flex-column quick-view-content">
            ...
            <div class="d-flex flex-column">
              <div class="d-flex align-items-center">
                <a href="#" class="add-to-cart furniture-card-hover-btn text-uppercase text-decoration-none text-white" data-id=${dataId}>
    ...
    //= ../working-with-cart/add-product-from-quick-view-modal.js
    mobileResizeModal();
  });
}
